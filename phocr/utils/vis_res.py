# -*- encoding: utf-8 -*-
# @Original Author: SWHL
# @Original Contact: liekkaskono@163.com
# @Modified by: Your Name (your_email@example.com)
import math
import random
...
DEFAULT_FONT_DIR = root_dir / "resources/fonts"
DEFAULT_FONT_PATH = DEFAULT_FONT_DIR / "方正宋黑.TTF"
...
class VisRes:
    ...
    def draw_one_rec_res(
        ...
        # font_path = self.get_font_path(DEFAULT_FONT_PATH, lang_type)
    ...
    def get_char_size(font, char_str: str) -> float:
        ...
        raise ValueError("The Pillow ImageFont instance has not getsize or getlength func.")

    @staticmethod
    def concat_imgs(imgs: List[np.ndarray], direction: str = "horizontal") -> np.ndarray:
